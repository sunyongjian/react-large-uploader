...
var _webuploader = require('../web/webuploader.html5only');
...
var BigUpload = function (_React$Component) {
  ...
  _createClass(BigUpload, [{
    ...
    value: function componentDidMount() {
      ...
      var uploader = _webuploader2.default.create(_extends({
        auto: false,
        chunked: true,
    ...
    value: function renderFileList() {
      ...
      return fileList.map(function (item) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: 'file-status ' + uploadStatus, onClick: _this2[clickName] ? _this2[clickName](id) : null },
            btn
          ),
          _react2.default.createElement(
            'span',
